...
_COLUMN_MIGRATIONS = [
    ...
    ('timer_sessions', 'pomodoro_phase', "ALTER TABLE timer_sessions ADD COLUMN pomodoro_phase VARCHAR(8)"),
    ('timer_sessions', 'phase_started_at', "ALTER TABLE timer_sessions ADD COLUMN phase_started_at DATETIME"),
    ('timer_sessions', 'target_seconds', "ALTER TABLE timer_sessions ADD COLUMN target_seconds INTEGER"),
